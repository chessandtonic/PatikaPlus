...
insert into employee (name, birthday, email) values ('Ophelie', '1966-09-21', 'ocrush2@histats.com');
...
insert into employee (name, birthday, email) values ('Roman', '1977-04-17', 'ostarbuckec@ameblo.jp');
...
insert into employee (name, birthday, email) values ('Filbert', '1984-10-06', 'farrigucciy@theglobeandmail.com');
...
insert into employee (name, birthday, email) values ('Laurette', '1987-11-27', 'lfonzog@ask.com');
